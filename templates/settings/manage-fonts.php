...
<div class="gffpdf-fonts-partial" style="padding:20px;">
	...
	<div class="upload-custom-fonts" style="border-bottom:1px solid #e5e7eb;padding-bottom:20px;">
		<h3 style="margin-top:0;"><?php esc_html_e( 'Upload Custom Font', 'gf-fillable-pdf-generator' ); ?></h3>
		<table class="form-table" style="margin:0;"><tbody>
			<tr>
				<th><label for="gffpdf-font-file-inline"><?php esc_html_e( 'Font File (.ttf / .otf)', 'gf-fillable-pdf-generator' ); ?></label></th>
				<td><input type="file" id="gffpdf-font-file-inline" accept=".ttf,.otf"></td>
			</tr>
			<tr>
				<th><label for="gffpdf-font-label-inline"><?php esc_html_e( 'Display Name', 'gf-fillable-pdf-generator' ); ?></label></th>
				<td><input type="text" id="gffpdf-font-label-inline" class="regular-text" placeholder="<?php esc_attr_e( 'e.g. My Custom Font', 'gf-fillable-pdf-generator' ); ?>"></td>
			</tr>
		</tbody></table>
		<p>
			<button type="button" id="gffpdf-font-upload-btn-inline" class="button button-primary"><?php esc_html_e( 'Upload Font', 'gf-fillable-pdf-generator' ); ?></button>
		...
		<table class="widefat" id="gffpdf-inline-custom-fonts-table" <?php echo empty($_custom_fonts) ? 'style="display:none;"' : ''; ?>>
			<thead>
				<tr>
					...
					<th><?php esc_html_e( 'Display Name', 'gf-fillable-pdf-generator' ); ?></th>
					<th><?php esc_html_e( 'Action', 'gf-fillable-pdf-generator' ); ?></th>
				</tr>
			</thead>
	...
	<div class="built-in-fonts" style="margin-top:24px;padding-bottom:20px;">
		<h3 style="margin-top:0;"><?php esc_html_e( 'Built-in Fonts', 'gf-fillable-pdf-generator' ); ?></h3>
